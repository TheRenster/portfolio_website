...
This repository contains the source code and assets for my personal portfolio website — a single-page app that showcases my background, projects, and contact information.
...
clarity_context_logo.png – Logo asset, suggesting at least one featured project or venture is Clarity Context.
...
How to keep a hosted app alive with GitHub Actions,
